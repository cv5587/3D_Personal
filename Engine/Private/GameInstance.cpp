...
CGameObject* CGameInstance::Find_CloneObject(_uint iLevelIndex, const wstring& strLayerTag, const _int& ID)
{
	if (nullptr == m_pObject_Manager)
		return nullptr;

	return m_pObject_Manager->Find_CloneObject(iLevelIndex, strLayerTag, ID);
}
